package io.github.objectobject.hexdummyexample.casting.actions.spells
...
object OpCongratulate : SpellAction {
    ...
    private data class Spell(val target: Entity) : RenderedSpell {
        ...
        override fun cast(env: CastingEnvironment) {
            env.printMessage("text.hexdummyexample.congrats".asTranslatedComponent(target.displayName));
        }
    }
}
