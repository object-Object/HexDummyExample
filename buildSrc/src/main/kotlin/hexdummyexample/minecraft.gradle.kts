...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexdummyexample.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexdummyexample-common-common-refmap.json
        // fixed:   hexdummyexample-common.refmap.json
