...
abstract class HexdummyexampleModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexdummyexampleModDependenciesExtension>("hexdummyexampleModDependencies")
